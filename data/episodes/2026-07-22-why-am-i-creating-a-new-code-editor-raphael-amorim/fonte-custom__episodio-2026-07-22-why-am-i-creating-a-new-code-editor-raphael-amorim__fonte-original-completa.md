...
URL de origem: https://rapha.land/why-am-i-creating-a-new-code-editor/

Data da fonte: 2026-07-22

Atribuição: Baseado no conteúdo "Why am I creating a new code editor? — Raphael Amorim". Original: https://rapha.land/why-am-i-creating-a-new-code-editor/. Adaptação em áudio gerada com inteligência artificial. Verifique os direitos do conteúdo original antes de publicar.

---

13 Nov • 2024 First and foremost, I would like to thank for all the financial investment that I have already received on this project. Even though it is not yet ready for the public, I truly appreciate the trust and support that many of you have placed in me.
...
For example, let’s jump into browsers universe: Many people would consider Arc browser as an innovative user experience, but some wouldn’t. Then you could find people that would consider a Firefox performance improvement based on a new architecture as an innovation example, but also would have people that would disagree.
...
This year has been quite busy for me as a new parent, and the few time that I had was to work on Rio terminal and create the editor prototype. As mentioned before, the current step has been iterated on personas and keep stabilizing the editor.
...
If you want to keep up to date, follow me on Twitter, Bsky or Mastodon.